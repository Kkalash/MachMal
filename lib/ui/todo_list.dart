...
class TodoList extends StatelessWidget {
  final CategoryFirebase currentCategory;
      ...
      return snapshot.data?.docs.isEmpty == true
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                TodoFirebase todo =
                    TodoFirebase.fromSnapshot(snapshot.data!.docs[index]);
...
// }
  ...
  Widget loadingData() {
    //pull todos again
    // todoBloc.getTodosByCategoryId(categoryId: currentCategory.categoryId!);
    return Center(
      child: Column(
